// Multilingual search suggestions - 7 different queries in different languages
export const MULTILINGUAL_SUGGESTIONS = [
  "Still life paintings", // English
...
export const DEFAULT_QUERY = "Paintings of winter landscapes";
